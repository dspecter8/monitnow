...
public class TestEntities {
	...
	public void ClipperTest1() {
		...
		PositionMower clipper1 = new PositionMower(new Repere(5, 5), Direction.NORTH);
		PositionMower clipperOK = new PositionMower(new Repere(5, 5), Direction.NORTH);
		PositionMower clipperKO = new PositionMower(new Repere(5, 5), Direction.SOUTH);
